...
function LoadConfig() {
    ...
    $("#website_config>.configs section.icon>img").attr("src", company.image?.small || "../../img/pop-black-icon.jpg");
    $("#website_config>.configs section.home-bg>img").attr("src", company.website_main_bg || `${api_url}/static/img/pop-bg.jpg`);
}
