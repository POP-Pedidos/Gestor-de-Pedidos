...
function UpdatePreview() {
    ...
    $("#product_editor form.seo .preview img.icon").attr("src", company.image?.small || "../../../images/pop-black-icon.jpg");
}

function UpdateImageSelectorActions() {
    const $list = $("#product_editor .image_selector>.list-container>.list");
